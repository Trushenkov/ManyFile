...
2. Запись чисел из текстового файла в файл целых чисел intdata.dat
3. Выбор из файла с исходными числами только те, числа которые удовлетворяют условию задачи и запись их в файл ind6data.dat.
4. Чтение из файла int6data.dat чисел и проверка их на то, являются они счастливыми билетами или нет.
5. Запись счастливых билетов в текстовый файл txt6data.txt
